#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Resolve HKEX stockIds and query announcements per stock for a date range."""
...
def resolve(ticker):
    ...
    try:
        ...
        print(f"resolve {ticker} fail: {e} raw={raw[:100]}")
    return None

TICKERS = ["1299", "2378", "0945", "2628", "2318", "0005", "2388", "1336", "1508", "1299-R"]
...
def main():
    ...
    for tk in TICKERS:
        ...
        try:
            ...
            time.sleep(0.3)
            continue
        print(f"=== {tk} (stockId {sid}): {len(rows)} announcements ===")
        for r in rows:
